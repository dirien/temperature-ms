...
import (
	"fmt"
	"it.schwarz/landmark/app/handler"
	"log"
	"net/http"
	"os"
	"os/signal"
...
func (app *App) setRouters() {
	...
	api.HandleFunc("/landmarks", app.handleRequest(handler.GetLandmarks)).Methods(http.MethodGet)
	api.HandleFunc("/landmarks", app.handleRequest(handler.AddNewLandmark)).Methods(http.MethodPost)
}
